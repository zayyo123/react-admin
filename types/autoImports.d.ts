...
declare global {
  // @ts-ignore
  export type { ApiPageSelectProps } from '../src/components/Selects/types'
  import('../src/components/Selects/types')
  // @ts-ignore
  export type { CheckboxList } from '../src/components/Table/components/TableFilter'
  import('../src/components/Table/components/TableFilter')
  // @ts-ignore
  export type { ThemeType, TabsData, FC, BusinessComponents, RangeValue, SearchModalProps, Langs, InitTableState, TableAction, EditorProps, FormData, FormList, SearchList, ApiSelectProps, ApiTreeSelectProps } from './autoImports.d'
